package com.csabacsete.imgursmostviral.matchers;
 ...
 */
public class CommonViewMatchers {
    ...
    public static Matcher<View> hasAnyText() {
    ...
    private static final class ActionOnItemViewAtPositionViewAction<VH extends RecyclerView
        ...
        public Matcher<View> getConstraints() {
            return org.hamcrest.Matchers.allOf(new Matcher[]{
