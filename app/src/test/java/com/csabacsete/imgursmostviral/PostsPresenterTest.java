...
import com.csabacsete.imgursmostviral.data.repositories.PostsRepository.GetPostsCallback;
import com.csabacsete.imgursmostviral.posts.ImgurContract;
import com.csabacsete.imgursmostviral.posts.PostsPresenter;
...
//    private static List<Post> POSTS = Lists.newArrayList(new Post("id1", "Title1"), new Post("id2", "Title2"));
    ...
    @Mock
    private ImgurContract.View mPostsView;
